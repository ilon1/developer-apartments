...
class DEV_Table_Module_V2 extends ET_Builder_Module{
    ...
    public function get_fields(){
        ...
        return array(
            'source_mode'   => array('label'=>'Režim zdroja','type'=>'select','options'=>array('manual'=>'Manuálny výber','context'=>'Z kontextu stránky (Theme Builder)'),'default'=>'context','tab_slug'=>'general','toggle_slug'=>'main_content'),
            'source_id'     => array('label'=>'Zdroj bytov','type'=>'select','options'=>$opts,'description'=>'Použije sa pri Režime zdroja = Manuálny výber.','toggle_slug'=>'main_content','tab_slug'=>'general'),

            // Columns toggles
            'show_col_ext'    => array('label'=>'Zobraziť stĺpec: Exteriér','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'columns'),
            'show_col_cellar' => array('label'=>'Zobraziť stĺpec: Pivnica','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'columns'),
            'show_col_total'  => array('label'=>'Zobraziť stĺpec: Celkom','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'columns'),
            'show_col_price'  => array('label'=>'Zobraziť stĺpec: Cena','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'columns'),
            'show_col_status' => array('label'=>'Zobraziť stĺpec: Status','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'columns'),

            // Labels
            'label_col_flat'   => array('label'=>'Názov stĺpca: Byt','type'=>'text','default'=>'Byt','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_int'    => array('label'=>'Názov stĺpca: Interiér','type'=>'text','default'=>'Interiér','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_ext'    => array('label'=>'Názov stĺpca: Exteriér','type'=>'text','default'=>'Exteriér','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_cellar' => array('label'=>'Názov stĺpca: Pivnica','type'=>'text','default'=>'Pivnica','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_total'  => array('label'=>'Názov stĺpca: Celkom','type'=>'text','default'=>'Celkom','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_price'  => array('label'=>'Názov stĺpca: Cena','type'=>'text','default'=>'Cena','tab_slug'=>'general','toggle_slug'=>'labels'),
            'label_col_status' => array('label'=>'Názov stĺpca: Status','type'=>'text','default'=>'Status','tab_slug'=>'general','toggle_slug'=>'labels'),

            // Colors
            'color_free'      => array('label'=>'Farba statusu: Voľný','type'=>'color-alpha','default'=>'#3aa655','tab_slug'=>'general','toggle_slug'=>'colors'),
            'color_reserved'  => array('label'=>'Farba statusu: Rezervovaný','type'=>'color-alpha','default'=>'#f0ad4e','tab_slug'=>'general','toggle_slug'=>'colors'),
            'color_sold'      => array('label'=>'Farba statusu: Predaný','type'=>'color-alpha','default'=>'#d9534f','tab_slug'=>'general','toggle_slug'=>'colors'),

            // Behavior
            'enable_sort'       => array('label'=>'Povoliť triedenie','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'items_per_page'    => array('label'=>'Položiek na stránku (0 = všetko)','type'=>'text','default'=>'0','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filters_enable'    => array('label'=>'Zobraziť panel filtrov','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filter_status'     => array('label'=>'Filter: Status','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filter_rooms'      => array('label'=>'Filter: Izby','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'off','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filter_area'       => array('label'=>'Filter: Plocha (min/max)','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'off','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filter_price'      => array('label'=>'Filter: Cena (min/max)','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'off','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'filter_search'     => array('label'=>'Filter: Hľadať názov','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'on','tab_slug'=>'general','toggle_slug'=>'behavior'),
            'export_csv'        => array('label'=>'Tlačidlo Export CSV','type'=>'yes_no_button','options'=>array('on'=>'Áno','off'=>'Nie'),'default'=>'off','tab_slug'=>'general','toggle_slug'=>'behavior'),
        );
    }
    ...
    private function resolve_source_term(){
        ...
        if (is_singular('apartment')) {
            ...
            if ($terms && !is_wp_error($terms)) return (string) $terms[0]->term_id;
        }
        return $manual;
    }
    ...
    private function builder_preview(){
        ...
        <div class="dev-apartment-table-wrapper dev-builder-preview">
            ...
            <div style="opacity:.6;margin-top:8px;font-size:12px;">Builder náhľad (statický). Reálne dáta sa načítajú na publiku.</div>
        </div>
    ...
    public function render($attrs,$content=null,$render_slug){
        if ( ! is_admin() ) {
            wp_enqueue_script( 'dev-apt-table', DEV_APT_URL.'includes/divi-modules/assets/table.js', array('jquery'), DEV_APT_VERSION, true );
        }
        ...
        $args=array(
            'post_type'=>'apartment','post_status'=>'publish',
            'posts_per_page'=>-1,'orderby'=>'title','order'=>'ASC'
        );
        if($src!=='' && $src!=='all'){
            $args['tax_query']=array(array(
                'taxonomy'=>'project_structure','field'=>'term_id',
                'terms'=>intval($src),'include_children'=>true
            ));
        }
        $q=new WP_Query($args);
        if(!$q->have_posts()) return '<p>Žiadne byty nenájdené.</p>';

        $L_flat=$this->props['label_col_flat']; $L_int=$this->props['label_col_int'];
        $L_ext=$this->props['label_col_ext'];   $L_cell=$this->props['label_col_cellar'];
        $L_tot=$this->props['label_col_total']; $L_pr=$this->props['label_col_price'];
        $L_st=$this->props['label_col_status'];
        ...
        <style>
            ...
            #<?php echo esc_js($uid); ?> thead th[data-sortable="1"]{position:relative;padding-right:18px}
            #<?php echo esc_js($uid); ?> thead th .sort-ico{position:absolute;right:6px;top:50%;transform:translateY(-50%);opacity:.45;font-size:11px}
        ...
        <div id="<?php echo esc_attr($uid); ?>" class="dev-apartment-table-wrapper"
            ...
            <table class="dev-table">
                <thead>
                <tr>
                    <th data-key="flat"  <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_flat); ?><span class="sort-ico"></span></th>
                    <th data-key="int"   <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_int);  ?><span class="sort-ico"></span></th>
                    <?php if($v_ext):  ?><th data-key="ext"   <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_ext);  ?><span class="sort-ico"></span></th><?php endif; ?>
                    <?php if($v_cell): ?><th data-key="cell"  <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_cell); ?><span class="sort-ico"></span></th><?php endif; ?>
                    <?php if($v_tot):  ?><th data-key="tot"   <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_tot);  ?><span class="sort-ico"></span></th><?php endif; ?>
                    <?php if($v_pr):   ?><th data-key="price" <?php if($enable_sort) echo 'data-sortable="1"'; ?>><?php echo esc_html($L_pr);   ?><span class="sort-ico"></span></th><?php endif; ?>
                    <?php if($v_st):   ?><th data-key="status"><?php echo esc_html($L_st);   ?></th><?php endif; ?>
                </tr>
                </thead>
                <tbody>
                <?php while($q->have_posts()): $q->the_post();
                    ...
                    $terms_ids = wp_get_post_terms(get_the_ID(),'project_structure',array('fields'=>'ids'));
                ...
                ?>
                    <tr data-href="<?php echo esc_url($permalink); ?>"
                        ...
                        data-int="<?php echo esc_attr($i_area ?: 0); ?>"
                        <?php if($v_ext): ?>data-ext="<?php echo esc_attr($e_area ?: 0); ?>"<?php endif; ?>
                        <?php if($v_cell): ?>data-cell="<?php echo esc_attr($cellar ?: 0); ?>"<?php endif; ?>
                        <?php if($v_tot): ?>data-tot="<?php echo esc_attr($t_area ?: 0); ?>"<?php endif; ?>
                        <?php if($v_pr): ?>data-price="<?php echo esc_attr( preg_replace('/\D+/','', strip_tags($price_html)) ?: 0 ); ?>"<?php endif; ?>
                        ...
                        <td data-label="<?php echo esc_attr($L_flat); ?>"><strong><?php the_title(); ?></strong></td>
                        ...
                        <?php if($v_pr):   ?><td data-label="<?php echo esc_attr($L_pr);   ?>"><?php echo $price_html; ?></td><?php endif; ?>
                        <?php if($v_st):   ?><td data-label="<?php echo esc_attr($L_st);   ?>"><?php echo $status_html; ?></td><?php endif; ?>
                    </tr>
